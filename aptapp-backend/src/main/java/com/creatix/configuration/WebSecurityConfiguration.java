    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, "/api/gym").permitAll()
                .antMatchers(HttpMethod.GET,  "/api/account/*/activate/*").permitAll()
                .antMatchers(HttpMethod.GET,  "/api/account/*/password-reset/*").permitAll()
