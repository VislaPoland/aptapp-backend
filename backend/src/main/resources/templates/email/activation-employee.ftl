                            ...
                            <table style="box-sizing: border-box; border-collapse: separate !important; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                                <tr>
                                    <td style="box-sizing: border-box; font-family: 'Helvetica Neue', Helvetica, Arial, 'Lucida Grande', sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                                        ...
                                        <p style="font-family: 'Helvetica Neue', Helvetica, Arial, 'Lucida Grande', sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px; text-align: center; color: #031821;">Hooray! Your property has teamed up with Apt. App offering YOU the technology to quickly prioritize your day, explore the neighborhood, and keep updated on community events. It’s a snap to use and we have a great feeling you are going to LOVE it!</p>
                                        ...
                                        <p style="font-family: 'Helvetica Neue', Helvetica, Arial, 'Lucida Grande', sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px; text-align: center; color: #031821;">Property Owners, Property Managers and Assistant Property Managers - Your username and password will also be valid for your Apt. App web-portal log-in.<br><a href="${applicationUrl}" style="box-sizing: border-box; color: #348eda; text-decoration: underline;">${applicationUrl}</a></p>
