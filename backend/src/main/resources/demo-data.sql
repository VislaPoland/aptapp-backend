...
-- administrator
INSERT INTO public.account (dtype, id, active, company_name, first_name, last_name, password_hash, primary_email, primary_phone, role, created_at) VALUES
  ('Account', 4, true, 'Cool Company', 'Joe', 'Admin', '$2a$10$IXniWKP6M12dNGoTzHW9Feo/7Jn4nke0GeRGvvU7n38WuYkY40eyG',
              'joe.admin@apartments.com', '123456789', 'Administrator', '2016-06-16 15:36:38');

-- property owner
INSERT INTO public.account (dtype, id, active, company_name, first_name, last_name, password_hash, primary_email, primary_phone, role, created_at) VALUES
  ('PropertyOwner', 1, true, 'South Water Apartments', 'Helen', 'Owner', '$2a$10$iNna7fvFEhY61WvFbc76Xe7ezV5uSHenCu/Yj8BS8x/d5yyxzd426',
                    'helen.owner@apartments.com', '(743) 635-5652', 'PropertyOwner', '2016-06-16 15:36:38');

-- address
INSERT INTO public.address (id, house_number, state, street_name, town, zip_code) VALUES
  (1, '747', 'IL', 'Main Street', 'Chicago', '606609');

-- property schedule
INSERT INTO public.property_schedule(id, start_hour, start_minute, end_hour, end_minute, slots_per_period, period_length) VALUES
  (1, 9, 0, 17, 0, 8, 30);

-- property
INSERT INTO public.property (id, name, status, address_id, owner_id, schedule_id, time_zone) VALUES
  (1, 'South Water Apartments', 'Active', 1, 1, 1, 'America/Chicago');
...
-- property manager
INSERT INTO public.account (dtype, id, active, company_name, first_name, last_name, password_hash, primary_email, primary_phone, role, managed_property_id, created_at) VALUES
  ('PropertyManager', 2, true, 'South Water Apartments', 'Mark', 'Building', '$2a$10$R6ntl54odFxGtmo/vFx.Kem91x5dXSVxjHLF7bCvHgpryYGShWUSq',
                      'mark.building@apartments.com', '(854) 253-6566', 'PropertyManager', 1, '2016-06-16 15:36:38');

-- employees
INSERT INTO public.account (dtype, id, active, company_name, first_name, last_name, password_hash, primary_email, primary_phone, role, created_at, manager_id) VALUES
  ('SecurityEmployee', 5, true, 'South Water Apartments', 'Martin', 'Security', '$2a$10$iNna7fvFEhY61WvFbc76Xe7ezV5uSHenCu/Yj8BS8x/d5yyxzd426',
                       'martin.security@apartments.com', '(743) 635-5651', 'Security', '2016-06-16 15:36:38', 2);
INSERT INTO public.account (dtype, id, active, company_name, first_name, last_name, password_hash, primary_email, primary_phone, role, created_at, manager_id) VALUES
  ('SecurityEmployee', 6, true, 'South Water Apartments', 'Martin', 'Maintenance', '$2a$10$iNna7fvFEhY61WvFbc76Xe7ezV5uSHenCu/Yj8BS8x/d5yyxzd426',
                       'martin.maintenance@apartments.com', '(743) 635-5651', 'Maintenance', '2016-06-16 15:36:38', 2);
...
-- tenant
INSERT INTO public.account (dtype, id, active, company_name, first_name, last_name, password_hash, primary_email, primary_phone, role, type, apartment_id, action_token, action_token_valid_until, created_at) VALUES
  ('Tenant', 3, false, 'South Water Apartments', 'John', 'Tenant', '$2a$10$pTLqZgRdpj/s.SP.ebNKauZXGOIOMxahdeKAswKgx24c7Q2YdLdCS',
             'apt@test.com', '(905) 545-0256', 'Tenant', 'Owner', 22, '123456', '2017-06-16 15:36:38', '2016-06-16 15:36:38');
...
-- apartments
INSERT INTO public.apartment (id, unit_number, property_id) VALUES (101, '1', 101);
INSERT INTO public.apartment (id, unit_number, property_id) VALUES (102, '2', 101);

INSERT INTO public.apartment_neighbor (id, unit_number, apartment_id) VALUES (101, '1', 101);
INSERT INTO public.apartment_neighbor (id, unit_number, apartment_id) VALUES (102, '2', 102);

UPDATE public.apartment SET above_id = 102 WHERE id = 101;
UPDATE public.apartment SET below_id = 101 WHERE id = 102;

-- property manager
INSERT INTO public.account (dtype, id, active, company_name, first_name, last_name, password_hash,
                            primary_email, primary_phone, role, managed_property_id, created_at)
VALUES ('PropertyManager', 102, true, 'Cool Company', 'Joe', 'Manager1', '$2a$10$M9hvOTL71BvwzoClkcOdYOarTyWIuirEFjV/08EOh7BvNpV.Ew9mG',
                           'joe.manager1@mail.com', '123456789', 'PropertyManager', 101, '2016-06-16 15:36:38');
INSERT INTO public.account (dtype, id, active, company_name, first_name, last_name, password_hash,
                            primary_email, primary_phone, role, managed_property_id, created_at)
VALUES ('PropertyManager', 103, true, 'Cool Company', 'Joe', 'Manager2', '$2a$10$djKfGlbkHPoD2FVM3DvRn.mfKR7OkTquEJyubIc.mJi3dBusOY4Ty',
                           'joe.manager2@mail.com', '123456789', 'PropertyManager', 102, '2016-06-16 15:36:38');

-- security account
INSERT INTO public.account (dtype, id, active, company_name, first_name, last_name, password_hash,
                            primary_email, primary_phone, role, manager_id, created_at)
VALUES ('SecurityEmployee', 104, true, 'Cool Company', 'Joe', 'Security', '$2a$10$uxh1J.QHtM5iiVoUEIA46.Ndt/Srp71L.0kn8x8bIAE0/kk22AeLK',
                            'joe.security@mail.com', '123456789', 'Security', 102, '2016-06-16 15:36:38');

-- maintenance account
INSERT INTO public.account (dtype, id, active, company_name, first_name, last_name, password_hash,
                            primary_email, primary_phone, role, manager_id, created_at)
VALUES ('MaintenanceEmployee', 105, true, 'Cool Company', 'Joe', 'Maintenance', '$2a$10$pjJnFRFriSqLgv9nEi8jWuW/BKk4xnNqyNJPUx5ietHXt3WWetorS',
                               'joe.maintenance@mail.com', '123456789', 'Maintenance', 102, '2016-06-16 15:36:38');

-- tenants
INSERT INTO public.account (dtype, id, active, action_token, action_token_valid_until, company_name, first_name, last_name,
                            primary_email, primary_phone, role, type, apartment_id, created_at)
VALUES ('Tenant', 106, false, '666666', '2017-06-16 15:36:38', 'Cool Company', 'Joe', 'Tenant1',
                  'joe.tenant1@mail.com', '123456789', 'Tenant', 'Owner', 101, '2016-06-16 15:36:38');
INSERT INTO public.account (dtype, id, active, company_name, first_name, last_name, password_hash,
                            primary_email, primary_phone, role, type, apartment_id, created_at)
VALUES ('Tenant', 107, true, 'Cool Company', 'Joe', 'Tenant2', '$2a$10$N/AhcCcImjmbsPRy4oDfOukA3.6xFE95qKoHAXEJbjOCJ3.JFPgZa',
                  'joe.tenant2@mail.com', '123456789', 'Tenant', 'Owner', 102, '2016-06-16 15:36:38');
